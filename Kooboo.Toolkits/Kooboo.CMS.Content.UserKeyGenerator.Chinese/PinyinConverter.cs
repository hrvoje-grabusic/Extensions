...
namespace Kooboo.CMS.Content.UserKeyGenerator.Chinese
{
    public class PinyinConverter
    {
        ...
        /// </summary>
        /// <param name="chineseString">Chinese characters string</param>
        /// <param name="separator">separator,eg: - </param>
        ...
        public static string GetPinyin(string chineseString, string separator = null)
        {
            ...
            int asc = 0, M1 = 0, M2 = 0;
            char[] mChar = chineseString.ToCharArray();//获取汉字对应的字符数组
            var tempString = string.Empty;//keep consequent non-Chinese string
            for (int j = 0; j < mChar.Length; j++)
            {
                //Is Chinese character
                if (chinesePattern.IsMatch(mChar[j].ToString()))
                {
                        ...
                        switch (asc)
                        {
                            ...
                            default:
                                for (int i = (getValue.Length - 1); i >= 0; i--)
                                {
                                    ...
                                    {
                                        result.Add(getName[i]);//如果不超出范围则获取对应的拼音
                                        break;
                                    }
                                }
                                break;
                ...
                {
                    //save to temp variable if not Chinese character
                    tempString += mChar[j];
                }
            }
